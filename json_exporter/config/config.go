...
// READING AND USER PROFILE 
config=open("SE-Grafana/conf.txt","r")
lines=config.readlines()
USERNAME=lines[0].split("AccessKeyId=")[1].replace("\n","")
PASSWORD=lines[1].split("AccessKeyValue=")[1].replace("\n","")
PATHCD=lines[2].split("PATH=https://api.solarweb.com/swqapi/pvsystems/c990f4b2-6d63-4620-8ab8-fb935344ba87/aggdata")[1].replace("\n","")
config.close()
